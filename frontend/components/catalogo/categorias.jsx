        ...
        <div style={{ padding: "20px" }}>
                ...
                <div className="row">
                    <div className="col">
                        <Link to="/categoriasCreate">
                            <button style={{ margin: "10px", padding: "10px 20px" }}>Crear categoría</button>
                        </Link>
                    </div>
                </div>
            </div>
            ...
            <div style={{ marginTop: "20px", textAlign: "center" }}>
                ...
                <p style={{ marginTop: "10px" }}>
                    Página {currentPage} de {totalPages} | Resultados: {filteredCategorias.length} | Total: {categorias.length}
                </p>
            </div>
        </div>
    );
